			...
			<div className={style.content}>
				...
				<div className={style.right}>
					<div class={style.card}>
						<img src='/images/project-101.png' alt='' className='img-project' />
					</div>
					<div class={style.card}>
						<img src='/images/project-102.png' alt='' className='img-project' />
					</div>
					<div class={style.card}>
						<img src='/images/project-103.png' alt='' className='img-project' />
					</div>
					<div class={style.card}>
						<img src='/images/project-104.png' alt='' className='img-project' />
					</div>
				</div>
			</div>
		</div>
